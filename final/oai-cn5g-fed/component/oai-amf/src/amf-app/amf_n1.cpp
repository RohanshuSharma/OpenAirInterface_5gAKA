...
void amf_n1::generate_5g_he_av_in_udm(
  ...
  Authentication_5gaka::f2345(
      ...
      ak,rk,sk);  // to compute XRES, CK, IK, AK
   output_wrapper::print_buffer("amf_n1", "Result For F5-Alg: rk", rk, 8);
   output_wrapper::print_buffer("amf_n1", "Result For F5-Alg: sk", sk, 8);
  annex_a_4_33501(
