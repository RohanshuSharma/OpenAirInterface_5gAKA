...
void f2345(u8 k[16], u8 rand[16], u8 res[8], u8 ck[16], u8 ik[16], u8 ak[6], u8 rk[8], u8 sk[8], u8 rk[8], u8 sk[8]);
...
void f2345(u8 k[16], u8 rand[16], u8 res[8], u8 ck[16], u8 ik[16], u8 ak[6], u8 rk[8], u8 sk[8]) {
  // u8 op_c[16];
  u8 temp[16];
  u8 out[16];
  u8 rijndaelInput[16];
  ...
  Authentication_5gaka::RijndaelKeySchedule(ak);
