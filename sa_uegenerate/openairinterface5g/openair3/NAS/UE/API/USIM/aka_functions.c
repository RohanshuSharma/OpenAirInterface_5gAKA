             ...
             u8 res_pP[8], u8 ck_pP[16], u8 ik_pP[16], u8 ak_pP[6],u8 mk_pP[8],u8 rk_pP[8],u8 sk_pP[8],const u8 op_c[16])
{
  ...
  LOG_TRACE(INFO,
            "USIM-API  - f2345 : out f2 mk[0..7]=%02X%02X%02X%02X%02X%02X%02X%02X",
            mk_pP[0],mk_pP[1],mk_pP[2], mk_pP[3], mk_pP[4], mk_pP[5], mk_pP[6], mk_pP[7]);
  LOG_TRACE(INFO,
  ...
  LOG_TRACE(INFO,
            "USIM-API  - f2345 : out f2 rk[0..7]=%02X%02X%02X%02X%02X%02X%02X%02X",
            rk_pP[0],rk_pP[1],rk_pP[2], rk_pP[3], rk_pP[4], rk_pP[5], rk_pP[6], rk_pP[7]);
  LOG_TRACE(INFO,
            "USIM-API  - f2345 : out f2 sk[0..7]=%02X%02X%02X%02X%02X%02X%02X%02X",
            sk_pP[0],sk_pP[1],sk_pP[2], sk_pP[3], sk_pP[4], sk_pP[5], sk_pP[6], sk_pP[7]);
  return;
